...
accounting and scheduling, Project and Queue, respectively. These resources are usually
...
definition (see the [Resources](https://snakemake.readthedocs.io/en/stable/snakefiles/rules.html#resources) document).
